    ...
    <section className="relative min-h-screen flex items-center justify-center bg-[#0B1120] overflow-hidden pt-6 lg:pt-2 pb-2" id="home">
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-8 sm:px-12 md:px-16 lg:px-20 grid grid-cols-1 lg:grid-cols-[1fr_1.1fr] gap-12 items-center">
        ...
        <div className="flex flex-col items-start max-lg:items-center max-lg:text-center animate-fade-in-up">
          <h1 className="text-xl sm:text-2xl md:text-[2.25rem] lg:text-[2.25rem] font-black leading-[1.2] text-white mb-6 tracking-tight">
            ...
            <br className="hidden lg:block" />
            Intelligent Digital Solutions by{' '}
            <br className="hidden lg:block" />
            <span className="text-brand-primary text-3xl sm:text-4xl md:text-[2.75rem] lg:text-[2.75rem] relative inline-block mt-2">Worldtek Innovations.
              <svg className="absolute w-full h-3 -bottom-2 left-0 text-brand-accent/50" viewBox="0 0 100 20" preserveAspectRatio="none">
